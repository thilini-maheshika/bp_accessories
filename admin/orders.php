...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12 title">
            <h1><i class="fa fa-bars"></i>Customer Orders <button class="btn btn-sm btn-default"><a
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="d-flex flex-column justify-content-between order-summary">
                                <div class="d-flex align-items-center">
                                    <div class="text-uppercase">Order #<?php echo $order_id ;?></div>
                            ...
                            <div>
                                ...
                                <select style=" background-color:  #AED6F1; width:50%;"
                                    onchange='orderChange(this, "<?php echo $order_id; ?>","order_status")'
                                    id="order_status <?php echo $order_id; ?>" class='form-control norad tx12'
                                    name="order_status" type='text'>

                                    <option value="1" <?php if ($row['order_status']=="1") echo "selected"; ?>>
                                        Order confirmed
                                    </option>
                                    <option value="2" <?php if ($row['order_status']=="2") echo "selected"; ?>>
                                        Prepare Order
                                    </option>
                                    <option value="3" <?php if ($row['order_status']=="3") echo "selected"; ?>>
                                        Shipped Order
                                    </option>
                                    <option value="4" <?php if ($row['order_status']=="4") echo "selected"; ?>>
                                        Delivered
                                    </option>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="track">
                                ...
                                <div class="step <?php if($row['order_status'] == 4) {echo 'active';}?>"> <span
