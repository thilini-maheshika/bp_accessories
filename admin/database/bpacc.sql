...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2022 at 12:47 AM
...
INSERT INTO `pre_order` (`pre_order_id`, `p_id`, `customer_name`, `customer_email`, `customer_phone`, `customer_address`, `preorder_total`, `is_deleted`, `date_updated`) VALUES
(1, 2, 'Thilini ', 'thili@gmail.com', '0778905678', 'Galle', 20000, 0, '2022-10-23 07:43:37');
...
(6, 31, 'ASUS Laptop 15 (X515MA) ', ' Intel Celeron Upto 2.8 Ghz, Finger Print', 6, 'AS-CEL-X515-487-128SSD-SL-02.jpg', 174999, -67, 2, 1, 0, '2022-10-15 21:39:57'),
...
(9, 31, 'Vivobook Pro', 'The colorful, bold and youthful Vivobook series shows who you really are. ', 6, 'download (2).jpg', 340000, -43, 1, 1, 0, '2022-10-15 21:39:58'),
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `pre_order`
  MODIFY `pre_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
