...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2022 at 06:54 AM
...
(40, 6, 2, '174999', 1, '2022-10-16 06:04:51'),
(41, 8, 9, '300000', 1, '2022-12-03 05:51:47');
...
(2, 'Thilini Maheshika', 'thili@gmail.com', '0713664071', 'Galle', '9923788723V', 'apple-iphone-14-pro-max-9.png', '12', 0, '2022-10-16 05:42:42'),
...
(9, 'Kanishka Sandaruwan', 'Kanishkadewsandaruwan@gmail.com', '0713664071', 'Banwalgodalla, Kosmulla', '962670426G', 'Image 19.png', '123456', 0, '2022-12-03 04:26:32');
...
(74, 2, '515149', 'Galle', 'Galle', 0, 1, 'Pending', '2022-10-15 21:39:57');
...
CREATE TABLE `pre_order` (
  ...
  `preorder_total` int(255) NOT NULL,
  `is_deleted` int(2) NOT NULL,
  `date_updated` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `pre_order_status` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pre_order` (`pre_order_id`, `p_id`, `customer_name`, `customer_email`, `customer_phone`, `customer_address`, `preorder_total`, `is_deleted`, `date_updated`, `pre_order_status`) VALUES
(1, 2, 'Thilini ', 'thili@gmail.com', '0778905678', 'Galle', 20000, 0, '2022-12-03 05:40:58', 4),
(2, 7, 'Kanishka Dew Sandaruwan', 'kanishkadewsandaruwan@gmail.com', '+94713664071', 'Banwalgodalla, Kosmulla', 300000, 0, '2022-12-01 17:37:05', 1),
(3, 7, 'Kanishka Dew Sandaruwan', 'kanishkadewsandaruwan@gmail.com', '+94713664071', 'Banwalgodalla, Kosmulla', 300000, 0, '2022-12-01 17:15:31', 0),
(4, 7, 'Kanishka Dew Sandaruwan', 'kanishkadewsandaruwan@gmail.com', '+94713664071', 'Banwalgodalla, Kosmulla', 300000, 0, '2022-12-01 17:45:35', 1),
(5, 7, 'Kanishka Dew Sandaruwan', 'kanishkadewsandaruwan@gmail.com', '0713664071', 'Banwalgodalla, Kosmulla', 300000, 0, '2022-12-02 16:11:02', 1),
(6, 7, 'Kanishka Dew Sandaruwan', 'kanishkadewsandaruwan@gmail.com', '+94713664071', 'Banwalgodalla, Kosmulla', 300000, 0, '2022-12-02 16:16:45', 1),
(7, 7, 'Kanishka Dew Sandaruwan', 'kanishkadewsandaruwan@gmail.com', '0713664071', 'Banwalgodalla, Kosmulla', 12, 0, '2022-12-03 05:37:15', 1);
...
(6, 31, 'ASUS Laptop 15 (X515MA) ', ' Intel Celeron Upto 2.8 Ghz, Finger Print', 6, 'AS-CEL-X515-487-128SSD-SL-02.jpg', 174999, -67, 2, 2, 0, '2022-12-03 05:42:18'),
(7, 32, 'TCL TAB 10 ', 'FHD WiFi (3GB+32GB) (Black) With Tab Cover', 7, '492-4925938_mobile-phones-and-tablets-hd-png-download.png', 90000, 0, 1, 1, 0, '2022-12-03 04:35:19'),
(8, 33, 'EOS 850D BODY +18-55MM LENS', '24.1-megapixel APS-C CMOS sensor + 4K video recording', 5, 'download.jpg', 300000, 2, 2, 1, 0, '2022-12-03 04:35:18'),
(9, 31, 'Vivobook Pro', 'The colorful, bold and youthful Vivobook series shows who you really are. ', 6, 'download (2).jpg', 340000, -43, 1, 2, 0, '2022-12-03 04:34:28'),
(10, 31, 'hello', 'dsgh', 2, '585-5852411_desktop-laptop-desktop-pc-and-laptop-hd-png.png', 12, 1, 1, 2, 0, '2022-12-03 04:34:30');
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `order_items`
  MODIFY `order_item_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`cust_id`) REFERENCES `customers` (`cust_id`);

--
-- Constraints for table `order_items`
--
ALTER TABLE `order_items`
  ADD CONSTRAINT `order_items_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `products` (`p_id`),
  ADD CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `order_products` (`order_id`);

--
-- Constraints for table `order_products`
--
ALTER TABLE `order_products`
  ADD CONSTRAINT `order_products_ibfk_1` FOREIGN KEY (`cust_id`) REFERENCES `customers` (`cust_id`);

--
-- Constraints for table `pre_order`
--
ALTER TABLE `pre_order`
  ADD CONSTRAINT `pre_order_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `products` (`p_id`);
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`model`) REFERENCES `model` (`mod_id`);
COMMIT;
